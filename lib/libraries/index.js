        ...
        if (options.legend.show === true
          && options.legend.position === 'right'
            && ['gauge'].indexOf(type.replace('horizontal-', ''))) {
                ...
                var formatValue;
                if (options.tooltip && options.tooltip.format && options.tooltip.format.value) {
                  formatValue = c3CustomTooltipFiltering.bind(this, options.tooltip.format.value);
                } else {
                  formatValue = c3CustomTooltipFiltering.bind(this, null);
                }
                options.tooltip = {
                  contents: c3TooltipContents,
                  format: Object.assign({}, options.tooltip && options.tooltip.format, {
                    value: formatValue
                  })
                };
...
function c3CustomTooltipFiltering(valueFunction, value, ratio, id, index) {
  var scope;
  if (this.view._artifacts.pagination
    && this.type() !== 'gauge'
      /*&& this.type() !== 'pie'
        && this.type() !== 'donut'*/) {
          ...
          if (scope.indexOf(id) > -1) {
            return valueFunction ? valueFunction(value, ratio, id, index) : value;
          }
  }
  else {
    return value;
